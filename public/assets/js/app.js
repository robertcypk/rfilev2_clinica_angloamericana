...
var App = (function () {
  ...
  // Active Menu Dinamic
  menuActive: function (index, active){
    var addedClass = $("ul.navbar-nav li:nth-child("+index+")");
    addedClass.addClass( "open" );
    addedClass.find("ul").find("li:nth-child("+active+") a").addClass( "active" );    
  }
